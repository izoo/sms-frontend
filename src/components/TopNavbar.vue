<template>
    ...
    <div class="topbar">
        ...
        <div class="topbar-left">
            ...
            <router-link to="/dashboard" class="logo" style="color:white;">
                <span>BULK SMS</span>
            </router-link>
        </div>

        <nav class="navbar-custom">
            <!-- <li>{{ localStorage.getItem('r') }}</li> -->
            ...
            <ul class="list-unstyled topbar-right-menu float-right mb-0">
                ...
                <li class="dropdown notification-list">
                    <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                       aria-haspopup="false" aria-expanded="false">
                        <img src="../assets/images/users/avatar-1.jpg" alt="user" class="rounded-circle"> <span class="ml-1">Admin <i class="mdi mdi-chevron-down"></i> </span>
                    </a>
  ...
  methods:{
    Logout(){
        if (confirm("Confirm  logout.")) {
            ...
            window.location.href=process.env.VUE_APP_PROJECT_BASE_URL;
        }
    }
  }
}
